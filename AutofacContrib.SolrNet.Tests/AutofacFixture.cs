...
namespace AutofacContrib.SolrNet.Tests {
    ...
    public class AutofacFixture {
        ...
        public void ReplaceHttpWebRequestFactory() {
            ...
            var response = new global::SolrNet.Tests.Mocks.HttpWebResponse {
                dispose = () => {},
            ...
            module.HttpWebRequestFactory = new global::SolrNet.Tests.Mocks.HttpWebRequestFactory {
                create = _ => new global::SolrNet.Tests.Mocks.HttpWebRequest {
                    getResponse = () => {
                        getResponseCalls++;
                        return response;
                    },

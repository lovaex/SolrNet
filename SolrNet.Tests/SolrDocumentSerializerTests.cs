...
namespace SolrNet.Tests {
    ...
    public partial class SolrDocumentSerializerTests {
        ...
        public void DocumentBoost() {
            ...
            var fs = ser.Serialize(doc, 2.1).ToString(SaveOptions.DisableFormatting);
        ...
        public void Location() {
            ...
            var fs = ser.Serialize(testDoc, null).ToString(SaveOptions.DisableFormatting);
        ...
        public void PropertyWithoutGetter() {
            ...
            var fs = ser.Serialize(new TestDocWithoutGetter(), null).ToString();
        }
        ...
        public void SupportsGenericDictionary_rest() {
            ...
            var fs = ser.Serialize(doc, null).ToString(SaveOptions.DisableFormatting);
            Assert.AreEqual("<doc><field name=\"Id\">5</field><field name=\"one\">1</field><field name=\"two\">2</field><field name=\"fecha\">2010-01-01T00:00:00Z</field><field name=\"SomeCollection\">a</field><field name=\"SomeCollection\">b</field><field name=\"SomeCollection\">c</field></doc>",
                fs);
        }
